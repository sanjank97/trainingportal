...
<!-- <div class="p-15 p-b-0">
    <form class="form-material">
        <div class="form-group form-primary">
            ...
            <label class="float-label"><i class="fa fa-search m-r-10"></i>Search Employess</label>
        </div>
    </form>
</div> -->
...
<ul class="pcoded-item pcoded-left-item">
    ...
    <li class="pcoded" id="li_grand_test">
        <a href="<?php echo BASE_URL; ?>courses/list.php?course_type=1" class="waves-effect waves-dark">
    ...
    <li class="pcoded" id="li_employee">
        <a href="<?php echo BASE_URL; ?>employee/list.php" class="waves-effect waves-dark">
    ...
    <li class="pcoded" id="li_users">
        <a href="<?php echo BASE_URL; ?>users/list.php" class="waves-effect waves-dark">
            <span class="pcoded-micon"><i class="ti-user"></i></span>
    ...
    <li class="pcoded" id="li_setting">
        <a href="<?php echo BASE_URL; ?>setting.php" class="waves-effect waves-dark">
            <span class="pcoded-micon"><i class="ti-settings"></i></span>
            <span class="pcoded-mtext" data-i18n="nav.basic-components.main">General Setting</span>
            <span class="pcoded-mcaret"></span>
        </a>
        <!-- <ul class="pcoded-submenu">
            <li class=" ">
...
$(document).ready(function() {
    ...
    if (url.match(/managequestion/)) {
       $('.pcoded').removeClass('active');
       $('#li_courses').addClass('active');
    }
    if (url=="https://www.a-aaron.com/trainingportal/admin/courses/list.php") {
       $('.pcoded').removeClass('active');
       $('#li_courses').addClass('active');
    }
    if (url=="https://www.a-aaron.com/trainingportal/admin/courses/list.php?course_type=1") {
       $('.pcoded').removeClass('active');
