            ...
            <div class="row">
                <div class="col-sm-12">
                    <!-- Authentication card start -->
                        <form class="md-float-material form-material" action="admin_handler.php" method="post" onsubmit="return validateForm()">
                                ...
                                <div class="card-block">
                                    <div class="row m-b-20 login">
                                        <div class="col-md-12">
                                            ...
                                            <!-- <p style="font-size: 16px;color: #000;">Sign in to your account</p> -->
                                        </div>
                                    </div>
                                    <?php 
                                    ...
                                    <div class="form-group form-primary">
                                        ...
                                        <input type="email" class="form-control" name="email" id="email" onblur="return emailValidate()">
                                    ...
                                    <div class="row m-t-25 text-left">
                                        <div class="col-12">
                                            <div class="forgot-phone text-right f-right">
                                                <!-- <a href="<?php echo BASE_URL;?>forgetpassword.php" class="text-right f-w-600"> Forgot Password?</a> -->
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row m-t-30">
                                        <div class="col-md-12">
                                            <button type="submit" name="admin_login" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20 theme-btn">Sign in</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
